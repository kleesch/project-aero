...
**Depends on:** 03 (parties link to businesses, so business _tables_ from 06 must exist or land first — coordinate migrations; the two phases are otherwise parallel)
